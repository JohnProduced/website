...
add_action('vc_before_init', 'mo_map_vc_elements');
            ...
            vc_map(array(
                ...
                "params" => array(
                    array(
                        ...
                        "description" => __("Custom CSS class name to be set for the icon element created. The class names are listed at https://www.livemeshthemes.com/support/faqs/how-to-use-1500-icons-bundled-with-the-agile-theme/", "js_composer")
                    ),
                    array(
                        "param_name" => "style",
                        "type" => "textfield",
                ...
                "params" => array(
                    array(
                        ...
                        "value" => array(
                            ...
                            __("iPhone 7 Black", "js_composer") => "iphone7black",
                            __("iPhone 7 Jet Black", "js_composer") => "iphone7jetblack",
                            __("iPhone 7 Silver", "js_composer") => "iphone7silver",
                            __("iPhone 7 Gold", "js_composer") => "iphone7gold",
                            __("iPhone 7 Rose Gold", "js_composer") => "iphone7rosegold",
                            __("Samsung Galaxy S7", "js_composer") => "galaxys7",
                            __("Nexus 6p", "js_composer") => "nexus6p",
                            __("Google Pixel Black", "js_composer") => "googlepixelblack",
                            __("Google Pixel Blue", "js_composer") => "googlepixelblue",
                            __("Google Pixel Silver", "js_composer") => "googlepixelsilver",
                            __("Samsung Galaxy S4", "js_composer") => "galaxys4",
            ...
            vc_map(array(
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "description" => __("The font icon to be displayed for the statistic being displayed. The class names are listed at https://www.livemeshthemes.com/support/faqs/how-to-use-1500-icons-bundled-with-the-agile-theme/", "js_composer")
                    ),
                    array(
